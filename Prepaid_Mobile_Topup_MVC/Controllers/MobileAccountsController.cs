...
namespace Prepaid_Mobile_Topup_MVC.Controllers
{
    public class MobileAccountsController : Controller
    {
        ...
        public MobileAccountsController(Prepaid_Mobile_Topup_MVCContext context)
        {
            _context = context;
        }
        ...
        {
            var prepaid_Mobile_Topup_MVCContext = _context.MobileAccount.Include(m => m.PrepaidCustomer);
        ...
        {
            ViewData["PrepaidCustomerId"] = new SelectList(_context.PrepaidCustomer, "Name", "Name");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Number,Balance,PrepaidCustomerId")] MobileAccount mobileAccount)
        {
            ...
            ViewData["PrepaidCustomerId"] = new SelectList(_context.PrepaidCustomer, "Id", "Id", mobileAccount.PrepaidCustomerId);
            return View(mobileAccount);
        }
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            ViewData["PrepaidCustomerId"] = new SelectList(_context.PrepaidCustomer, "Name", "Name", mobileAccount.PrepaidCustomerId);
            return View(mobileAccount);
        }
